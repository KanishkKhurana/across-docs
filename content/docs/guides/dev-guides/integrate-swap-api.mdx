...
- **Track the deposit** — poll `/deposit/status` to confirm the fill. See [Tracking Deposits](/docs/introduction/tracking-deposits).
- **Add an integrator ID** — required for production. See the [Swap API reference](/docs/introduction/swap-api#integrator-id).
...
- **Add embedded actions** — execute operations on the destination chain after the bridge. See [Crosschain Deposit into Aave](/docs/guides/dev-guides/crosschain-aave-deposit).
