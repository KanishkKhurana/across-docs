...
<Callout type="info">
  BNB Smart Chain is the first chain using [Across V4's ZK settlement](/docs/guides/concepts/across-v4). No testnet is available — test on mainnet with small amounts.
</Callout>
