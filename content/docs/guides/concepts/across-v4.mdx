...
V4 only changes the **settlement layer** (Phase 3 of the [intent lifecycle](/guides/concepts/intent-lifecycle)). The user experience and relayer network remain the same — users still get ~2 second fills.
