...
<Steps>
  ...
  <Step>
    ...
    This is enabled through [embedded crosschain actions](/introduction/embedded-actions) — instructions attached to the intent that execute on the destination chain after the fill.
  </Step>
  <Step>
    ...
    This is the current state, powered by [Across Settlement](/guides/concepts/intents-architecture) infrastructure.
  </Step>
</Steps>
...
See [ERC-7683 in Production](/guides/concepts/erc-7683) for implementation details.
