...
The current implementation uses **fixed fees** with relayer competition strictly based on **speed**. The [Swap API](/introduction/swap-api) is the primary RFQ interface.
...
<Callout type="info">
  The modular design means each layer can evolve independently. New RFQ mechanisms, new relayer strategies, and new settlement approaches (like [Across V4's ZK proofs](/guides/concepts/across-v4)) can be added without disrupting the rest of the system.
</Callout>
