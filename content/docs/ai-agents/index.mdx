...
| **[MCP Server](/docs/ai-agents/mcp-server)** | Claude Desktop, Cursor, Windsurf, VS Code Copilot, Codex | Point your client at `https://mcp.across.to/mcp` — search docs, query chains, get live bridge fees |
...
For contract addresses and explorer links, see the [Chains & Contracts](/docs/chains-and-contracts) page. For the live list, query the [`/swap/chains`](/docs/api-reference) endpoint.
...
<Cards>
  <Card title="MCP Server" href="/docs/ai-agents/mcp-server">
