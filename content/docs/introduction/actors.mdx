...
- The [Swap API](/introduction/swap-api) (most common)
- [ERC-7683](/guides/concepts/erc-7683) `open()` calls
...
LPs earn fees based on pool utilization — the more the pool is used for crosschain rebalancing, the higher the LP fee percentage. See [Fees in the System](/introduction/fees) for details on the utilization-based pricing model.
...
See [Security Model](/introduction/security) for more details on the verification and dispute process.
