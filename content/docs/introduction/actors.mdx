...
LPs earn fees based on pool utilization — the more the pool is used for crosschain rebalancing, the higher the LP fee percentage. See [Fees in the System](/docs/introduction/fees) for details on the utilization-based pricing model.
...
4. **Computes** crosschain transfer instructions for rebalancing
