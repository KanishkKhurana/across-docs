...
<Callout type="info">
  The `recipient` parameter should be set to the **MulticallHandler** contract address on the destination chain. This is the contract that executes your actions. See [contract addresses](/api-reference) for each chain.
</Callout>

## Examples

<Cards>
  <Card title="Transfer ERC-20 Tokens" href="/introduction/embedded-actions/transfer-erc20">
    Transfer swapped tokens to a different address on the destination chain.
  </Card>
  <Card title="Deposit ETH into Aave" href="/introduction/embedded-actions/deposit-eth-aave">
    Swap to ETH and deposit directly into Aave's lending pool.
  </Card>
  <Card title="Add HubPool Liquidity" href="/introduction/embedded-actions/hubpool-liquidity">
    Swap to ETH and add liquidity to the Across HubPool in one transaction.
  </Card>
  <Card title="Simple ETH Transfer" href="/introduction/embedded-actions/native-eth-transfer">
    Send native ETH to an address after a crosschain swap.
  </Card>
  <Card title="Nested Parameters" href="/introduction/embedded-actions/nested-parameters">
