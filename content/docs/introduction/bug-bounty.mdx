---
title: Bug Bounty
description: Report vulnerabilities and earn rewards through the Across Protocol bug bounty program.
icon: ShieldAlert
---
...
Please email your submissions to [bugs@across.to](mailto:bugs@across.to).
