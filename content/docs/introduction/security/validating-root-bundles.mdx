...
| **Rebalancing instructions** | Cross-chain token transfers correctly balance the SpokePools |
...
<Steps>
  ...
  <Step>
    ...
    If the roots don't match, the validator files a dispute on the HubPool. See [Disputing Root Bundles](/docs/introduction/security/disputing-root-bundles) for the dispute process.
  </Step>
</Steps>
