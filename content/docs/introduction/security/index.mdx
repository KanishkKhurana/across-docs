...
<Cards>
  <Card title="Disputing Root Bundles" href="/introduction/security/disputing-root-bundles">
    How to challenge an invalid proposal — manually or with automated tooling.
  </Card>
  <Card title="Validating Root Bundles" href="/introduction/security/validating-root-bundles">
