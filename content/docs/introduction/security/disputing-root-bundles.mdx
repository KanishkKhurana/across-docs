...
<Callout type="warn">
  **Only dispute if you are confident the proposal is invalid.** If the DVM votes that the proposal was valid, you lose your bond (~0.45 ABT / ETH). Run validation checks before disputing — see [Validating Root Bundles](/introduction/security/validating-root-bundles).
</Callout>
